    ...
    return (
        <ul className="mt-3 space-y-2 pl-4">
            {items.map((item, idx) => (
                <li
                    key={idx}
                    className="relative text-[var(--foreground)]/80"
                >
...
const CARD_TEXT_CLASSNAME = "mt-[10px] text-[var(--foreground)]/80";
const SECTION_TITLE_CLASSNAME = "font-stix text-[44px] leading-[54px] text-[var(--foreground)]";
const ACCORDION_TITLE_CLASSNAME = "font-plus-jakarta-sans text-[24px] leading-[30px] text-[var(--button-red)]";
                ...
                <Tabs defaultValue="domains">
                    ...
                    <div className="mt-[16px] rounded-[18px] bg-white px-[26px] py-[22px] md:px-[36px] md:py-[28px]">
                        ...
                        <TabsContent value="domains">
                            ...
                            <p className="mt-[10px] max-w-[980px] text-[var(--foreground)]/80">
                        ...
                        <TabsContent value="details">
                            ...
                            <div className="mt-[26px] grid gap-[22px] md:grid-cols-1">
                                ...
                                <AccordionItem title="Training Duration" defaultOpen titleClassName={ACCORDION_TITLE_CLASSNAME}>
                                    <p className="mt-[10px] text-[var(--foreground)]/80">
                                ...
                                {/* Training Venue */}
                                <AccordionItem title="Training Venue" defaultOpen titleClassName={ACCORDION_TITLE_CLASSNAME}>
                                    <p className="mt-[10px] text-[var(--foreground)]/80">
                                    ...
                                    />
                                    <p className="mt-[3px] text-[var(--foreground)]/80">
                                ...
                                {/* Trainers Profile */}
                                <AccordionItem title="Trainers Profile" defaultOpen titleClassName={ACCORDION_TITLE_CLASSNAME}>
                                    <p className="mt-[10px]">
                                ...
                                {/* Training Cost */}
                                <AccordionItem title="Training Cost" defaultOpen titleClassName={ACCORDION_TITLE_CLASSNAME}>
