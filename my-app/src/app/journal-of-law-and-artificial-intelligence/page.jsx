...
const JournalOfLawAndAIPage = () => {
    ...
    const journalQuickLinks = [
        {
            ...
            description: "The Journal of Law and Artificial Intelligence follows a double-blind peer-review process to ensure the highest standards of academic integrity and quality in published research.",
        ...
        },
        {
            ...
            description: "We adhere to strict ethical guidelines regarding authorship, conflict of interest, and research integrity, ensuring that all published work meets international ethical standards.",
        ...
        },
        {
            ...
            description: "JLAI provides immediate open access to its content on the principle that making research freely available to the public supports a greater global exchange of knowledge.",
        ...
        },
        {
            ...
            description: "The journal is committed to being indexed in major academic databases to increase the visibility, accessibility, and impact of the research published within its volumes.",
        ...
        },
        {
            ...
            description: "JLAI maintains a zero-tolerance policy towards plagiarism. All submitted manuscripts are screened using advanced plagiarism detection software (Drillbit) before review.",
        ...
        },
        {
            ...
            description: "The journal ensures the long-term preservation of its digital content through robust archiving strategies, guaranteeing that published research remains accessible for future generations.",
            icon: "https://cdn.kalingauniversity.ac.in/academics/icons/teachings.svg",
            href: "#"
        }
    ];
    ...
    const contactInfo = {
        ...
        imageSrc: "https://cdn.kalingauniversity.ac.in/academics/Library+Resouces.jpg",
        showQuotes: false
    };
        ...
        <div className="pt-[100px] md:pt-0">
            <MainIntro
                ...
                description={[
                    "E-ISSN NO. : 2584-2579",
                    "Impact Factor: 5.67",
                    "Journal of Law and Artificial Intelligence is a peer-reviewed, bi-annual academic publication dedicated to examining the evolving intersections of law, technology, and society. It provides a dynamic platform for multidisciplinary scholarship that critically engages with how law and artificial intelligence are reshaping legal systems, rights, responsibilities, and governance across the globe."
                ]}
