...
const MentorIntroProps = [
  {
    ...
    message: "CCRC is a platform where learning meets leadership, the right skillset meets industry requirements, and innovation turns into transformation. As the Head of the Career and Corporate Resource Centre (CCRC) at Kalinga University, it is my privilege to empower our students on their journey into the professional world and support corporates and working professionals in achieving maximum output. Beyond providing interview opportunities in our campus placement drives, we also ensure that every candidate is ready to confidently clear different interview rounds and get placed at top companies. Through aptitude training, resume-building sessions, expert-led workshops, industrial visits, live projects, mock interview preparation, and industry-focused curriculum, we make them ready for the global job market. Apart from training and placements, we offer customised solutions in multiple dimensions like corporate training, consultancy services, HRIS development, CSR initiatives, and incubation solutions for budding entrepreneurs. We approach every project with excellence and commitment. I sincerely thank all our recruitment partners for turning the aspirations of our students into rewarding careers and corporate partners for their continued trust and collaboration. I warmly welcome more companies and organisations to work with us and generate capable future leaders.",
