...
const defaultButtons = [
    { id: 1, text: "Edition 8 - Volume 4, Issue -2 July 2025 - December 2025", href: "https://cdn.kalingauniversity.ac.in/ieee/Vol4+issue+2.pdf" },
    { id: 2, text: "Edition 7 - Volume 4, Issue -1 January 2025 - June 2025", href: "https://cdn.kalingauniversity.ac.in/ieee/Vol4+issue+1.pdf" },
    { id: 3, text: "Edition 6 - Volume 3, Issue - 2 July - December 2024", href: "https://cdn.kalingauniversity.ac.in/ieee/vol3+issue+2.pdf" },
    { id: 4, text: "Edition 5 - Volume 3, Issue- 1 January - June 2024", href: "https://cdn.kalingauniversity.ac.in/ieee/vol3+issue+1.pdf" },
    { id: 5, text: "Edition 4 - Volume 2, Issue 2 July 2023-December 2023", href: "https://cdn.kalingauniversity.ac.in/ieee/vol+2+issue+2.pdf" },
    { id: 6, text: "Edition 3 - Volume 2, Issue 1 January - June 2023", href: "https://cdn.kalingauniversity.ac.in/ieee/vol+2+issue+1.pdf" },
    { id: 7, text: "Edition 2 - Volume 1, Issue 2 October \u2013December 2022", href: "https://cdn.kalingauniversity.ac.in/ieee/vol+1+issue+2.pdf" },
    { id: 8, text: "Edition 1 - Volume 1, Issue 1 April-September 2022", href: "https://cdn.kalingauniversity.ac.in/ieee/vol1+issue+1.pdf" },
];

const imageSrc = "https://cdn.kalingauniversity.ac.in/IQAC/kalinga.webp";
const message = "For research collaboration, testing services, and technical support, please contact us.";

export default function IEEEClient() {
    ...
    return (
        <>
            ...
            <FAQ
                ...
                tableSections={[
                    ...
                    },
                    {
                        ...
                        data: [
                            { slNo: 1, name: "Dr. Vijayalaxmi Biradar", designation: "IEEE WIE AG Advisor", membershipId: "92478983" },
                            { slNo: 2, name: "Ms. Aayushi Rao", designation: "Chairperson", membershipId: "100043089" },
                            { slNo: 3, name: "Ms. Chilikuri Shivani", designation: "Vice Chairperson", membershipId: "100666290" },
                        ],
                    },
                    {
                        id: 3,
                        ...
                        description: (
                            <div className="space-y-3">
                                <p>The mission is to provide a responsive and relevant professional society that attracts, engages, aids, and retains a diverse set of members worldwide. AESS at KU will accomplish this through technical, chapter, and society activities through conferences, publications, education, technical operations, industry relations, and member services.</p>
                        ...
                        data: [
                            { slNo: 1, name: "Dr. Vijayalaxmi Biradar", designation: "IEEE AESS Chapter Advisor", membershipId: "92478983" },
                            { slNo: 2, name: "Mr. Priyanshu Singh", designation: "Chairperson", membershipId: "100071524" },
                            { slNo: 3, name: "Ms. Goon Shah", designation: "Vice Chairperson", membershipId: "101177641" },
                        ],
                    },
                    {
                        id: 4,
                        ...
                        description: (
                            <div className="space-y-3">
                                <p>Established on 13th June under the IEEE Student Branch, the IEEE Computer Society Chapter at Kalinga University promotes excellence in computing, software, and emerging technologies. Dedicated to IEEE’s mission of \u201cAdvancing Technology for Humanity\u201d, the society empowers members to contribute to impactful solutions in the field of computer science.</p>
                        ...
                        data: [
                            { slNo: 1, name: "Dr. Vijayalaxmi Biradar", designation: "IEEE CS Chapter Advisor", membershipId: "92478983" },
                            { slNo: 2, name: "Mr. Vedant Raj", designation: "Chairperson", membershipId: "100057335" },
                        ],
                    },
                    {
                        id: 5,
                    ...
                    },
                    {
                        ...
                        columns: [
                            { key: "slNo", label: "S. No.", width: "w-20" },
                            { key: "event", label: "Name of the Event", width: "w-80" },
                            { key: "date", label: "Date of the Event", width: "w-48" },
                        ],
                        data: [
                ...
                tabs={[
                    {
                        ...
                        content: (
                            <div className="space-y-6">
                                <h3 className="text-white">22/11/2024 to 23/11/2024 - Event Schedule</h3>
                                <div className="overflow-x-auto rounded-xl border border-gray-300">
                                    <table className="w-full border-collapse text-left">
                                        ...
                                        <tbody className="bg-white">
                                            <tr>
                                                <td className="border border-gray-300 px-4 py-3 font-medium align-middle" rowSpan={8}>Day \u2013 1<br />22-11-2024</td>
                                                ...
                                                <td className="border border-gray-300 px-4 py-3 align-middle font-medium" rowSpan={15}>Kalinga University Auditorium</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td className="border border-gray-300 px-4 py-3 font-medium align-middle" rowSpan={7}>Day \u2013 2<br />23-11-2024</td>
                    ...
                    },
                    {
                        ...
                        content: (
                            <div className="space-y-6">
                                <h3 className="text-white">22/11/2024 to 23/11/2024 - Inauguration Schedule</h3>
                                    ...
                                    <table className="w-full border-collapse text-left">
                                        ...
                                        <tbody className="bg-white">
                                            <tr>
                                                ...
                                                <td className="border border-gray-300 px-4 py-3 align-middle font-medium" rowSpan={11}>Kalinga University Auditorium</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td className="border border-gray-300 px-4 py-3">SDG \u2013 Logo Launching Ceremony and Inauguration of SDG Wall headed by Mrs. Saloni Tyagi, HoD Faculty of Law</td>
                                            </tr>
                                            <tr>
                    ...
                    },
                    {
                        ...
                        content: (
                            <div className="space-y-6">
                                <h3 className="text-white">22/11/2024 - Poster / Project Presentation Schedule</h3>
                    ...
                    },
                    {
                        ...
                        content: (
                            <div className="space-y-6">
                                <h3 className="text-white">23-11-2024 - Valedictory Schedule</h3>
                                    ...
                                    <table className="w-full border-collapse text-left">
                                        ...
                                        <tbody className="bg-white">
                                            <tr>
                                                ...
                                                <td className="border border-gray-300 px-4 py-3 align-middle font-medium" rowSpan={7}>Kalinga University Auditorium</td>
                                            </tr>
                                            <tr>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-5 lg:gap-0 container pt-[50px] pb-10">
                            ...
                            <div className="absolute right-4 bottom-4 z-30">
                                ...
                                >
                                    <svg width={20} height={20} viewBox="0 0 16 16" fill="none" className="text-white">
                                        <path d="M4 12L12 4M12 4H6M12 4V10" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </button>
                            </div>
                        )}
                ...
                <div className="lg:col-span-8 flex flex-col gap-6 relative lg:left-[-25px] z-10">
            ...
            {/* Basic Popup Implementation for missing state */}
            {isPopupOpen && (
