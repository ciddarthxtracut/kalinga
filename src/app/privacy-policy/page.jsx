...
export const metadata = {
  title: "Privacy Policy | Kalinga University",
  description:
    "Learn about how Kalinga University collects, uses, and protects your personal information. Our privacy policy ensures transparency and security for all our website visitors and students.",
  keywords: [
    "Privacy Policy",
    "Data Protection",
    "Kalinga University Privacy",
    "Information Security",
    "User Data Policy",
    "Privacy Terms",
  ],
  alternates: {
    canonical: "https://kalingauniversity.ac.in/privacy-policy/",
  },
};
...
export default function PrivacyPolicyPage() {
  const jsonLd = {
    ...
    "@type": "WebPage",
    "name": "Privacy Policy - Kalinga University",
    "description": "Privacy policy and data protection guidelines of Kalinga University.",
    "publisher": {
      "@type": "University",
