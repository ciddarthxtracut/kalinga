                        ...
                        <div className="mt-6 rounded-xl bg-white p-8">
                            <TabsContent value="infra">
                                <div className="space-y-6">
                                    <h2 className={SECTION_TITLE_CLASSNAME}>Infrastructure (Basic Amenities) Development of Government Schools</h2>
                                    <p className={CARD_TEXT_CLASSNAME}>
                                        An infrastructure development program for Government schools in rural areas of Naya Raipur was conducted by the National Service Scheme (NSS) unit and Internal Quality Assurance Cell (IQAC) of Kalinga University from 22-08-2022 to 27-08-2022. This program aimed to provide basic amenities to Government schools present in rural areas to develop their infrastructure. In total, <strong> 6 faculty members</strong> and <strong>30 students</strong> participated in the event.
                                    </p>
                                    <p className={CARD_TEXT_CLASSNAME}>During the program, a team from the NSS unit and the IQAC cell of Kalinga University visited the following seven schools:</p>
                                    ...
                                    <p className={CARD_TEXT_CLASSNAME}>
                                        Initially, a survey was carried out to fetch the requirements of the Government schools, and based on this, various amenities like Green Board, Carpet, Dustbin, Almira, Book Rack, wheel chair, etc., were distributed to the above Government schools of Naya Raipur. This initiative brought a smile to the faces of the students and teachers of the schools. Finally, the Head Master/Mistress appreciated this initiative of Kalinga University by providing an appreciation certificate.
                                    </p>
                                    <div className="mt-8">
                                        <Gallery
                                            title="Glimpses"
                            ...
                            <TabsContent value="survey">
                                <div className="space-y-6">
                                    <h2 className={SECTION_TITLE_CLASSNAME}>Village / Household Surveys in the Kalinga University UBA Adopted Villages</h2>
                                        ...
                                        <table className="w-full border-collapse text-left">
                                            ...
                                            <tbody className="bg-white">
                                                <tr>
                                                    ...
                                                    <td className="border border-gray-300 px-4 py-3">03-11-2022</td>
                                                    <td className="border border-gray-300 px-4 py-3">Palaud</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">52</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">2</td>
                                                    <td className="border border-gray-300 px-4 py-3">04-11-2022</td>
                                                    <td className="border border-gray-300 px-4 py-3">Kotni</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">52</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">3</td>
                                                    <td className="border border-gray-300 px-4 py-3">05-11-2022</td>
                                                    <td className="border border-gray-300 px-4 py-3">Tandul</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">52</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">4</td>
                                                    <td className="border border-gray-300 px-4 py-3">07-11-2022</td>
                                                    <td className="border border-gray-300 px-4 py-3">Kuhera</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">49</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">5</td>
                                                    <td className="border border-gray-300 px-4 py-3">08-11-2022</td>
                                                    <td className="border border-gray-300 px-4 py-3">Parsada</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">60</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">6</td>
                                                    <td className="border border-gray-300 px-4 py-3">09-11-2022</td>
                                                    <td className="border border-gray-300 px-4 py-3">Kotara Bhata</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">54</td>
                                                </tr>
                                                <tr className="font-semibold bg-gray-50">
                                                    <td colSpan="3" className="border border-gray-300 px-4 py-3 text-center">Total Number of Houses Surveyed</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">319</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <p className={CARD_TEXT_CLASSNAME}>
                                        Under the UBA scheme, Kalinga University, Raipur, has adopted six villages, and in these villages, separate teams were assigned to collect data from every house in that area. A meeting was conducted with the village Sarpanch, and basic information related to the village, like village infrastructure, amenities/services availability, details of the land, forest, and horticulture field in the village, was collected.
                                    </p>
                                    <p className={CARD_TEXT_CLASSNAME}>
                                        Along with this, the requirements of the common electrical appliances for the village were also discussed. The household survey started from <strong> 3<sup>rd</sup> November 2022</strong> and was completed on <strong> 9<sup>th</sup> November 2022</strong>.
                                    </p>
                                </div>
                            </TabsContent>
                            ...
                            <TabsContent value="garbage">
                                <div className="space-y-6">
                                    <h2 className={SECTION_TITLE_CLASSNAME}>Smart Garbage Monitoring System in Government Schools</h2>
                                    <div className="overflow-x-auto rounded-xl border border-gray-300">
                                        <table className="w-full border-collapse text-left">
                                            <thead className="bg-[var(--dark-blue)] text-white">
                                                <tr>
                                            ...
                                            <tbody className="bg-white">
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">1</td>
                                                    <td className="border border-gray-300 px-4 py-3">03-10-2023</td>
                                                    <td className="border border-gray-300 px-4 py-3">Government Middle School, Kuhera</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">53</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">2</td>
                                                    <td className="border border-gray-300 px-4 py-3">04-10-2023</td>
                                                    <td className="border border-gray-300 px-4 py-3">Government Middle School, Tandul</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">57</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">3</td>
                                                    <td className="border border-gray-300 px-4 py-3">05-10-2023</td>
                                                    <td className="border border-gray-300 px-4 py-3">Government Middle School, Palaud</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">64</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">4</td>
                                                    <td className="border border-gray-300 px-4 py-3">06-10-2023</td>
                                                    <td className="border border-gray-300 px-4 py-3">Mahatma Vidya Pith School, Palaud</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">42</td>
                                                </tr>
                                                <tr>
                                                    <td className="border border-gray-300 px-4 py-3">5</td>
                                                    <td className="border border-gray-300 px-4 py-3">07-10-2023</td>
                                                    <td className="border border-gray-300 px-4 py-3">Government Middle School, Kotara Bhata</td>
                                                    <td className="border border-gray-300 px-4 py-3 text-center">52</td>
                                                </tr>
                                                <tr className="font-semibold bg-gray-50">
                                                    <td colSpan="3" className="border border-gray-300 px-4 py-3 text-center">Total Number of Students Attended</td>
                                    ...
                                    <p className={CARD_TEXT_CLASSNAME}>
                                        Government schools often struggle with maintaining a clean and hygienic environment. Improper garbage disposal can lead to unclean surroundings, attracting pests and causing health issues for students and staff members. Implementing a smart garbage monitoring system in government schools can have several benefits and impacts, leading to improved hygiene, sustainability, and cost-efficiency. With real-time monitoring and alerts, the system can ensure that garbage bins are emptied promptly, reducing the risk of litter and unhygienic conditions.
                                    </p>
                                    <p className={CARD_TEXT_CLASSNAME}>
