...
export default function ChairmanMessage({
  ...
  return (
    <section className="bg-white pt-8 md:pt-20 lg:pt-50 pb-8 md:pb-16 mt-10 md:mt-0">
      <div className="px-2">
        <div className="bg-[var(--dark-blue)] rounded-xl px-4 py-4 md:py-8 md:px-6 lg:px-8 relative overflow-visible">
          {/* Top Section - Portrait, Name, and Quote */}
          <div className="grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-6 relative z-30 md:h-[280px] h-[600px]">
            {/* Left - Portrait */}
            ...
            <div className="md:col-span-8 flex flex-col gap-0 md:gap-4 lg:gap-5 order-2 md:order-2 md:transform md:-translate-y-[35%]">
              {/* Name and Title */}
              <div className="text-center md:text-left pl-0 md:pl-[20px] mb-2 md:mb-0">
                {name && (
              ...
              <div className="bg-[var(--dark-blue)] md:bg-transparent rounded-xl p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-14 relative overflow-hidden mt-2 md:mt-0">
                ...
                <div className="relative z-10">
                  <p className="text-white leading-relaxed pt-6 md:pt-10 lg:pt-18 pb-3 md:pb-6 font-plus-jakarta-sans text-sm md:text-base">
                    {quote}
                  </p>
                  {/* Attribution */}
          ...
          <div className="bg-white rounded-lg p-4 md:p-6 lg:p-10 relative mt-2 md:mt-10 z-20">
