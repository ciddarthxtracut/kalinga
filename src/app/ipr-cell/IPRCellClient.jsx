...
const MentorIntroProps = [
    {
        ...
        imageSrc: "https://cdn.kalingauniversity.ac.in/ipr/ipr-sir.webp",
...
const committeeMembers = [
    { sno: 1, name: "Dr. R. Uday Kumar, Dean CS & IT", position: "Head" },
    { sno: 2, name: "Dr. Vijayalaxmi Biradar, Professor, Dept. of Engineering, Director IQAC", position: "Member" },
    { sno: 3, name: "Dr. Rahul Mishra, Professor, Dept. of Engineering, DAA & COE", position: "Member" },
    { sno: 4, name: "Dr. Sushma Dubey, Head Dept. of Biotechnology", position: "Member" },
    { sno: 5, name: "Dr. Amit Joshi, Asst. Professor, Dept. Biotechnology, Asst. COE", position: "Member" },
];

const IPR_READMORE_PDF = "https://drive.google.com/file/d/1cWxnWUWoh6d470GLwo8cMtnAvSKJFtiP/view";

export default function IPRCellClient() {
    const columns = [
